...
float eps = 0.5;//the radius for searching neighbor points of octree
int min_pets = 100;
int min_cluster_pts = 100;
...
int main(int argc, char** argv)
{
	...
	pcl::io::loadPCDFile<pcl::PointXYZ>("out_put_cluster_51.pcd", *cloud);//load the pcd file
	float resolution = 0.2f;//resolution of octree
